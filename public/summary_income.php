...
// ---------- ดึงรายรับแยกตามประเภทบุญ ----------
$rows = [];
$grand_total = 0;
$total_count = 0;
$sql = "
    SELECT m.merit_name AS label,
...
// ---------- ดึงรายละเอียดรายการ (มีแบ่งหน้า) ----------
$limit = 20;
$page  = isset($_GET['page']) ? max(1, intval($_GET['page'])) : 1;
$offset = ($page - 1) * $limit;

$count_stmt = $conn->prepare("
    SELECT COUNT(*) AS c FROM donation_items
...
// เก็บ query string สำหรับ pagination/export (ตัด page ออก)
...
<head>
<meta charset="UTF-8">
<title>สรุปรายรับ รายเดือน / ไตรมาส / ปี</title>
...
<div class="container mt-4">
    <h3 class="mb-4"><i class="bi bi-graph-up-arrow text-success"></i> สรุปรายรับ (รายเดือน / ไตรมาส / ปี)</h3>
    ...
    <div class="card shadow-sm p-3">
        <h5 class="text-success mb-3">รายละเอียดรายการ (<?php echo number_format($total_detail); ?> รายการ)</h5>
            ...
            <table class="table table-bordered table-sm bg-white">
                <thead class="table-success">
                    <tr>
                        ...
                        <th>ชื่อบนใบโม</th>
                        <th>ประเภทบุญ</th>
                        <th class="text-end">จำนวนเงิน (เยน)</th>
                        <th>หมายเหตุ</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($d['comment']); ?></td>
                    </tr>
                    <?php endforeach; ?>
...
function updateExcelLink() {
    ...
    document.getElementById('excelBtn').href = 'summary_income_export.php?' + params;
}
