...
// ===== Sheet เดียว: รายละเอียด =====
$rows = [];
$rows[] = [['s' => 'รายละเอียดรายการรายจ่าย — ' . $period_title]];
...
$zip->addFromString('xl/workbook.xml',
    ...
    . '<sheets><sheet name="รายละเอียด" sheetId="1" r:id="rId1"/></sheets>'
    . '</workbook>');
...
$filename = 'expense_detail_' . $mode . '_' . $start_date . '_to_' . $end_date . '.xlsx';
